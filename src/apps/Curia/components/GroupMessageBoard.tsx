...
import { getMessages, postMessage, isMember, getUser } from '../groups'
import type { CuriaGroup, GroupMessage } from '../groups'
...
export default function GroupMessageBoard({ eventId, group }: Props) {
  const user = getUser()
